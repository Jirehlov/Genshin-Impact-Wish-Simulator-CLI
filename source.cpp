...
enter_wishes_number:
        ...
        enter_cleanornot:
            ...
            if (chosen_banner == 3 && chosen_event > 14) {
            enter_profile_0:
                std::cout << S_138 << endl << S_139 << endl << endl << S_67 << endl
                    << S_69 << " ( " << pname[up_five_g[0]] << " ) " << endl
                    << S_70 << " ( " << pname[up_five_g[1]] << " ) " << endl
                    << S_71 << endl << endl;
                std::cin >> sav[8];
                ...
                else if (sav[8] == 0) { std::cout << endl; goto enter_profile_1; }
                else { else_counter++; }
                std::cout << endl;
            enter_profile_01:
                std::cout << S_138 << endl << S_139 << endl << endl << S_140 << endl << endl;
                std::cin >> sav[9];
        ...
        apply_profile:
            ...
            enter_ij:
                ...
                enter_d_item:
                    ...
                    if ((countx < 1 && zero_input_recheck) || d_item_n[ij] > LLONG_MAX) { std::cout << endl << S_72 << endl; goto enter_d_item; }
                    std::cout << endl;
                }
