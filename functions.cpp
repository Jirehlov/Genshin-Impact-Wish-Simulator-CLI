...
void lang_cout(unsigned int sq, size_t sw) {
  if (lang_status == 0) {
    switch (sq) {
      case 1:
        std::cout << pstring_en[sw];
        break;
      case 2:
        std::cout << pname_en[sw];
        break;
      case 3:
        std::cout << pnameshort_en[sw];
        break;
      case 4:
        std::cout << perror_en[sw];
        break;
      case 5:
        std::cout << pvalue_en[sw];
        break;
      case 6:
        std::cout << pachieve_en[sw];
        break;
      case 7:
        std::cout << pdetails_en[sw];
        break;
      default: {
        std::cout << EN_E_13 << '\n' << CN_E_13 << '\n';
        error_code = 13;
    ...
    switch (sq) {
      case 1:
        std::cout << pstring_cn[sw];
        break;
      case 2:
        std::cout << pname_cn[sw];
        break;
      case 3:
        std::cout << pnameshort_cn[sw];
        break;
      case 4:
        std::cout << perror_cn[sw];
        break;
      case 5:
        std::cout << pvalue_cn[sw];
        break;
      case 6:
        std::cout << pachieve_cn[sw];
        break;
      case 7:
        std::cout << pdetails_cn[sw];
        break;
      default: {
        std::cout << EN_E_13 << '\n' << CN_E_13 << '\n';
        error_code = 13;
